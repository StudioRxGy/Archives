...
import os
from configparser import ConfigParser, NoSectionError, NoOptionError  # 修改导入方式
...
class Config:
    ...
    def get_config(self, section: str, option: str) -> str:
        ...
        except (NoSectionError, NoOptionError) as e:  # 直接使用异常类
            print(f"配置文件读取错误: {e}")
            return None
    ...
    def get_section(self, section: str) -> dict:
        ...
        except NoSectionError as e:  # 直接使用异常类
            print(f"配置文件读取错误: {e}")
            return {}
