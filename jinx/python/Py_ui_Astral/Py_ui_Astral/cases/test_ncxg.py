...
class TestLogin(unittest.TestCase):
    ...
    def save_screenshot(self, name="screenshot"):
        png_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), './report/png')
    ...
    def test_01(self, user, pwd, expect, notes):
        ...
        # 清除并输入用户名
        username_input = driver.find_element(By.XPATH, "//input[@placeholder='邮箱或手机号']")
        ...
        # 点击登录按钮
        login_button = driver.find_element(By.XPATH, "//div[contains(@class, 'jss42')]/div[4]")
        login_button.click()
