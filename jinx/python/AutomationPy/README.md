...
# [概况]()
* 拉取代码: git clone https://github.com/StudioRxGy/AutomationPy  
* 本项目是使用的 Visual Studio编译器，使用conda进行的版本控制
...
* Linux
    ...
    * 安装tesseract-ocr，下载tesseract-4.1.1.tar.gz，下载地址：https://github.com/tesseract-ocr/tesseract/releases
        ...
        * sudo ldconfig
* Windows
    * 安装Microsoft Visual C++ 2019 Redistributable，下载地址如下：
...
* 配置selenium server
    ...
    * 下载地址:http://selenium-release.storage.googleapis.com/3.141/selenium-server-standalone-3.141.0.jar
