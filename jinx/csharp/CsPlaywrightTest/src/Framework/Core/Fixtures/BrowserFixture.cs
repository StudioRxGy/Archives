...
namespace EnterpriseAutomationFramework.Core.Fixtures;
...
public class BrowserFixture : BaseTestFixture
{
    ...
    /// <param name="environment">环境名称，默认为 Development</param>
    public BrowserFixture(ILogger logger, string environment = "Development") 
        : base(logger)
    {
