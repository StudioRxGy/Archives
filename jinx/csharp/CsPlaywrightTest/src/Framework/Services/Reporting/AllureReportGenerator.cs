...
public class AllureReportGenerator : IReportGenerator
{
    ...
    public async Task<string> GenerateReportAsync(TestReport testReport, string outputPath)
    {
        try
        {
            ...
            _logger.LogInformation("Allure报告生成完成: {OutputPath}", outputPath);
            return outputPath;
        }
        catch (Exception ex)
        {
    ...
    private async Task<AllureTestResult> CreateAllureTestResultAsync(EnterpriseAutomationFramework.Core.Models.TestResult testResult, string containerUuid)
    {
    ...
    private StatusDetails? CreateStatusDetails(EnterpriseAutomationFramework.Core.Models.TestResult testResult)
    {
    ...
    private List<Label> CreateLabels(EnterpriseAutomationFramework.Core.Models.TestResult testResult)
    {
    ...
    private string DetermineSeverity(EnterpriseAutomationFramework.Core.Models.TestResult testResult)
    {
        // 根据测试分类确定严重性
    ...
    private List<Link> CreateLinks(EnterpriseAutomationFramework.Core.Models.TestResult testResult)
    {
    ...
    private List<Parameter> CreateParameters(EnterpriseAutomationFramework.Core.Models.TestResult testResult)
    {
    ...
    private async Task<List<Attachment>> CreateAttachmentsAsync(EnterpriseAutomationFramework.Core.Models.TestResult testResult)
    {
    ...
    private string GenerateHistoryId(EnterpriseAutomationFramework.Core.Models.TestResult testResult)
    {
