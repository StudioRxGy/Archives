...
namespace CsPlaywrightApi.src.playwright.Tests.astralx.heyuye
{
    ...
    public class UheyueApiTests : IClassFixture<Fixture>
    {
        ...
        {
            var sourceFile =
                @"CsPlaywrightApi\src\playwright\Tests\Api\astralx\heyuye\UheyueApiTests.cs";

            _fixture.Logger.CurrentTestMethod = methodName;
            _fixture.Logger.CurrentTestClass =
                "CsPlaywrightApi.src.playwright.Tests.astralx.heyuye.UheyueApiTests";
        ...
        public async Task Test03_CreateBtcOrder_ShouldSuccess()
        {
            ...
            SetTestContext(
                ...
                "测试03 - 创建BTC市价买入订单",
                "市价买入测试",
                new List<string> { "API", "Trade", "BuyOrder" },
                "High"
            );
        ...
        public async Task Test04_CreateBtcOrder_ShouldContainOrderId()
        {
            ...
            SetTestContext(
                ...
                "测试04 - 验证订单响应包含必要字段",
                "市价买入测试",
                new List<string> { "Trade", "Validation" },
                "Medium"
            );
        ...
        public async Task Test05_ClosePosition_ShouldSuccess()
        {
            ...
            SetTestContext(
                ...
                "测试05 - 执行闪电平仓",
                "闪电平仓测试",
                new List<string> { "API", "Trade", "ClosePosition" },
                "High"
            );
        ...
        public async Task Test07_CompleteTradeFlow_ShouldSuccess()
        {
            ...
            SetTestContext(
                ...
                "完整流程测试",
                new List<string> { "API", "E2E", "FullFlow" },
                "Critical"
            );
        ...
        public async Task Test08_CreateOrderWithoutToken_ShouldThrowException()
        {
            ...
            SetTestContext(
                ...
                "异常场景测试",
                new List<string> { "API", "Exception", "Negative" },
                "Medium"
            );
            ...
            await Assert.ThrowsAsync<InvalidOperationException>(async () =>
                await btcApi.CreateBtcOrderAsync()
            );
        ...
        public async Task Test09_CreateOrderWithEmptyToken_ShouldThrowException()
        {
            ...
            SetTestContext(
                ...
                "异常场景测试",
                new List<string> { "Exception", "Negative" },
                "Medium"
            );
