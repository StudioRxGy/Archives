...
namespace Nop.Plugin.Api.Controllers
{
    ...
    public class NewsLetterSubscriptionController : BaseApiController
    {
        ...
        public async Task<IActionResult> DeactivateNewsLetterSubscription([FromRoute] string email)
        {
            ...
            // TODO: Update for newer nopCommerce versions - NewsLetterSubscription service methods may have changed
            ...
            // {
            //     return Error(HttpStatusCode.NotFound, "news_letter_subscription", "news letter subscription not found");
            // }
